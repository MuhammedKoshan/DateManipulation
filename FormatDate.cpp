...
string FormateDate(stDate Date, string DateFormat = "dd/mm/yyyy")
{
    ...
    Formatted = ReplaceWordInString(Formatted, "dd", to_string(Date.Day));
    Formatted = ReplaceWordInString(Formatted, "mm", to_string(Date.Month));
    Formatted = ReplaceWordInString(Formatted, "yyyy", to_string(Date.Year));
